  ...
  return (
    <div className='px-5 lg:px-20'>
      <section>
        ...
        <div>
            <Grid container spacing={2}>
                ...
                <Grid item xs = {12} lg={6}>
                    <img className='w-full h-[40vh] object-cover' src="https://cdn.pixabay.com/photo/2017/01/26/02/06/platter-2009590_960_720.jpg" alt="" />
                </Grid>
            </Grid>
        </div>
      ...
      <section className="pt-[2rem] lg:flex relative">
        ...
        <div className="space-y-5 lg:w-[80%] lg:pl-10">{menu.menuItems.map((item) => <MenuCard item={item}/>)}</div>
      </section>
    </div>
  )
}
